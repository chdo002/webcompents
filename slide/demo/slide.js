   ...
   Slider.prototype={
       ...
       self.next.addEventListener('click',function(){
   	 ...
   	 render:function(){
   	 	  ...
   	 	  //var prevHeight=window.getComputedStyle(self.prev,'prev').getPropertyValue('height');//找到左右切换按钮的高度
   	 	  
   	 	  var prevHeight=this.prev.offsetHeight;
   	 	 // console.log(prevHeight);
   	 	 // console.log(window.getComputedStyle(this.prev,null).height);
        ...
        this.clearActive();
        //this.listItems[index].classList.add('active');
 ...
 */
   ...
   TODO:
     ...
     3. 配置默认项  X
     4. 添加底部文字信息 X
     5. 兼容，addEventListener,classList,forEach
     5. 不在html写dom，在js里用模板拼接************待定
     4. 实现移动端适配屏幕与事件
     5. css命名,防止冲突
     6. 兼容到ie9，ie10,在兼容ie8
   */
   /*
   BUG:
    1. 获取元素高度出问题，找不到元素的高度，getComputedStyle*/